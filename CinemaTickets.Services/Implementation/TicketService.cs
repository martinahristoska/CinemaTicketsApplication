...
namespace CinemaTickets.Services.Implementation
{
    public class TicketService : ITicketService
    {
        ...
        public TicketService(IRepository<Ticket> ticketRepository, ILogger<TicketService> logger, IRepository<TicketInCart> ticketInCartRepository, IUserRepository userRepository)
        {
